...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_white, col_gray2, col_green },
};
...
static Key keys[] = {
	...
	/* config perso */
	{ Mod4Mask,         						XK_Tab,						 spawn,          SHCMD("tmux next-window") },
	...
	{ MODKEY,         						  XK_KP_Add,				 spawn,          SHCMD("volumeup") },
	{ MODKEY,         						  XK_KP_Subtract,    spawn,          SHCMD("volumedown") },
	{ MODKEY,         						  XK_KP_Multiply,    spawn,          SHCMD("volumemute") },
